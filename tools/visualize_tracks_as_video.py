...
class VideoBuilder:
    ...
    def build_video(
        ...
        med_ret = MediaRetriever(
            avro_api.get_url().replace(
                "/home/fjm/data/sports/videos/nhlGoldStandard",
                "/home/matthew/NFS_Store/ComputerVision/sports/nhlGoldStandard",
            )
        )
