...
#         self.y = y
#         if bound:
#             self.x = min(max(lb_x, x), ub_x)
#             self.y = min(max(lb_y, y), ub_y)
...
# from vitamincv.data.response.data import Region, Point, make_whole_image_contour


# contour = make_whole_image_contour()
# for pt in contour:
#     print(pt.dict)
