...
class FrameExtractor(CVModule):
    ...
    def _write_frame(self, frame, tstamp, video_id):
        ...
        full_path = "".join([e for e in full_path if e.isalnum() or "/"])
    ...
    def update_response(self):
        ...
        p = create_prop(server=self.name, ver=self.version, value=url, property_type="extraction", footprint_id=fp["id"], property_id=1)
