...
class Request():
    def __init__(self, request_dict, request_id=None):
        ...
        self._request = self._load_params(self._request)
        self._url = _cleanse_url(self._request.get("url"))
    ...
    def get_prev_response_url(self):
        return self._prev_response_url
